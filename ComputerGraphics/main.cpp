...
return indices.isComplete() && extensionsSupported && swapChainAdequate;
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
        ...
        // »спользовать VK_MEMORY_PROPERTY_HOST_COHERENT_BIT дл€ согласовани€ пам€ти хоста с пам€тью видеокарты
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        ...
        // ¬ отличие от команд рисовани€, копирование можно провести здесь и сейчас, необходимо лишь дождатьс€ его завершени€
    ...
    void createCommandBuffers() {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            // ‘ункци€ vkCmdBindVertexBuffers используетс€ дл€ прив€зки вершинных буферов
...
#pragma endregion
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        // »значально GLM был разработан дл€ OpenGL, где ось Y в пространстве отсечени€ имеет противоположное направление.
        ubo.proj[1][1] *= -1;
